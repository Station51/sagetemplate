@if (has_nav_menu('primary_navigation'))
  ...
  {{-- <header class="nav">  --}}
    ...
    <nav class="nav-slide">
        <div class="logo-cont">
            <div class="nav-brand-logo"><a class="mob-home-btn" href="/">@if(get_field('logo', 'option')){!! wp_get_attachment_image(get_field('logo', 'option', 'icon')) !!} @endif</a></div>
        </div>
        <!-- <div class="nav-menu-head"><php echo get_theme_mod('ptm_mobile_menu_company_name');?></div> -->
        <div class="nav-cont">
    ...
    <div class="brand-logo">@if(get_field('logo', 'option')){!! wp_get_attachment_image(get_field('logo', 'option', 'icon')) !!} @endif</div>

    <div class="header-cta-section">
        <div class="header-phone">
            {{-- <a href="tel:+@php echo get_theme_mod('ptm_phone_number'); @endphp"><i class="fa fa-phone"></i>@php echo get_theme_mod('ptm_phone_number'); @endphp</a> --}}
            @if(get_field('telephone', 'option')) 
              <a href="tel:{{ get_field('telephone', 'option') }}">{!! get_field('telephone', 'option') !!}</a>
            @endif
        </div>
